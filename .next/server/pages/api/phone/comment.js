...
const handler = async (req, res)=>{
    ...
    switch(method){
        case "POST":
            const newPhoneComment = new _models_PhoneComment__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z(req.body);
...
var __webpack_exports__ = __webpack_require__.X(0, [198], () => (__webpack_exec__(3362)));
