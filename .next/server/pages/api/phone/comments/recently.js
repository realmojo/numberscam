...
const handler = async (req, res)=>{
    ...
    switch(method){
        case "GET":
            const recentlyItems = await _models_PhoneComment__WEBPACK_IMPORTED_MODULE_1__/* ["default"].find */ .Z.find({
                isDelete: false
            }).sort({
                created: -1
            }).limit(20);
...
var __webpack_exports__ = __webpack_require__.X(0, [198], () => (__webpack_exec__(6715)));
